...
ASGI_APPLICATION = "leerming.asgi.application"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "leerming": {
            "handlers": ["stdout"],
            "level": env("LEERMING_LOG_LEVEL", default="INFO"),
        },
    },
}
...
ROOT_URLCONF = "leerming.urls"

SECRET_KEY = env("SECRET_KEY", default="django-insecure-Ce59kRiOBoA6YJx-es7-876rbJgqeP7TYTdR--MgYsw")
...
WSGI_APPLICATION = "leerming.wsgi.application"
...
ACCOUNT_FORMS = {"signup": "leerming.users.forms.UserSignupForm"}
